		...
		<div className="container"> 
			...
			<div className="footer-links-wrapper row"> 
				...
				<div className="links-wrapper-3 col-sm-12 col-md">
					<h3 className="shop">Apple Store</h3>
					<ul className="ulshop">
				...
				<div className="links-wrapper-4 col-sm-12 col-md">
					<h3 className="shop">For Business</h3>
					<ul className="ulshop">
						<li><a href="#">Apple and Business</a></li>
						<li><a href="#">Shop for Business</a></li>
					</ul>		
					<h3 className="shop">For Education</h3>
					<ul className="ulshop">
						<li><a href="#">Apple and Education</a></li>
						<li><a href="#">Shop for College</a></li>
					</ul>
					<h3 className="shop">For Healthcare</h3>
					<ul className="ulshop">
						<li><a href="#">Manage Your Apple ID</a></li>
						<li><a href="#">Apple Store Account</a></li>
						<li><a href="#">iCloud.com</a></li>
					</ul>	
					<h3 className="shop">For Government</h3>
					<ul className="ulshop">
						<li><a href="#">Apple and Education</a></li>
						<li><a href="#">Shop for College</a></li>
					</ul>
				...
				<div className="links-wrapper-5 col-sm-12 col-md">
					<h3 className="shop">Apple Values</h3>
					<ul className="ulshop">
						<li><a href="#">Find a Store</a></li>
						<li><a href="#">Genius Bar</a></li>
						<li><a href="#">Today at Apple</a></li>
					...
					<h3 className="shop">About Apple</h3>
					<ul className="ulshop">
						<li><a href="#">Find a Store</a></li>
						<li><a href="#">Genius Bar</a></li>
						<li><a href="#">Today at Apple</a></li>
